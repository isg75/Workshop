...
Si no dispones de una instalación adecuada de `Python` y `jupyter`, puedes ejecutar el *notebook* haciendo *click* en el botón siguiente: [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/isg75/Workshop/blob/main/notebooks/notebook-ardillas.ipynb)
